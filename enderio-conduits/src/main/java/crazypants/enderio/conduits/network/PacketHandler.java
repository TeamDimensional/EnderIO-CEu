...
public class PacketHandler {
  ...
  public static void init(FMLInitializationEvent event) {
    ...
    INSTANCE.registerMessage(PacketOpenConduitSwapperGui.Handler.class, PacketOpenConduitSwapperGui.class, nextID(), Side.CLIENT);
    ...
    INSTANCE.registerMessage(PacketRequestConduitSwapper.Handler.class, PacketRequestConduitSwapper.class, PacketHandler.nextID(), Side.SERVER);
    INSTANCE.registerMessage(PacketApplyConduitSwapper.Handler.class, PacketApplyConduitSwapper.class, PacketHandler.nextID(), Side.SERVER);
